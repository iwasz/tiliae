...
BOOST_AUTO_TEST_CASE (test012StringList)
{
        ...
        BOOST_REQUIRE_EQUAL (list->operator[] (0), "value01");
        BOOST_REQUIRE_EQUAL (list->operator[] (1), "value02");
        BOOST_REQUIRE_EQUAL (list->operator[] (2), "value03");
        BOOST_REQUIRE_EQUAL (list->operator[] (3), "value04");
        BOOST_REQUIRE_EQUAL (list->operator[] (4), "value05");

        v = cont->getBean ("mojaLista2");
        BOOST_REQUIRE_EQUAL (list->operator[] (0), "value01");
        BOOST_REQUIRE_EQUAL (list->operator[] (1), "value02");
}
