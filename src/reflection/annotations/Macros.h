...
#define _tb _tb_implementation_arg(BOOST_PP_CAT(TOKEN,__COUNTER__))

#define _t(NClazz)  NClazz::REFLECT_INIT_METHOD_NAME <NClazz> (BOOST_PP_STRINGIZE (NClazz));
...
#define _te _te_implementation_arg(BOOST_PP_CAT(TOKEN,BOOST_PP_DEC(BOOST_PP_DEC(__COUNTER__))))


#define _e(Clazz) _e_implementation_arg(Clazz, BOOST_PP_CAT(ServiceClass,BOOST_PP_CAT(__COUNTER__, __LINE__)))

#define __e(Clazz) __c(void); _e(Clazz)

//#define __ne(NClazz, Token) __c(void); _ne(NClazz, Token)
