...
Tag property równa się wywołaniu settera danego obiektu. Oczywiście setter musi mieć javowy format setNazwa i musi być dostępny z poziomu refleksji (czyli zaadnotowany za pomocą np. REFLECTION_METHOD). Atrybuyu tagu to :
