...
{
        try {
                BeanFactoryContainer *beanContainer = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "001-simplest-bean.xml"));
...
{
        BeanFactoryContainer *beanContainer = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "002-simplest-bean-value-string.xml"));
...
{
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "003-simplest-bean-value-text.xml"));
...
{
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "004-simplest-bean-value-empty.xml"));
...
{
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "005-little-more-complicated-bean.xml"));
