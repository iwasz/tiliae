...
BOOST_AUTO_TEST_CASE (test081TEnum)
{
        ...
        BeanFactoryContainer *container = ContainerFactory::create (metaContainer, true);
...
{
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "082-parent-with-inner.xml"));
...
{
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "083-prop-alias.xml"));
        Foo *foo1 = vcast<Foo *> (cont->getBean ("childBean1"));
        Foo *foo2 = vcast<Foo *> (cont->getBean ("childBean2"));
...
{
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "084-inner-singleton.xml"));
...
{
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "085-linked-01.xml"), true);
        Bar *bar1 = vcast<Bar *> (cont->getBean ("mojBean"));

        BeanFactoryContainer *cont2 = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "085-linked-02.xml"), false, cont);
...
BOOST_AUTO_TEST_CASE (test086GlobalInitMethod)
{
        ...
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "086-global-init-method.xml"));
...
BOOST_AUTO_TEST_CASE (test087GlobalIdMethod)
{
        ...
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "087-global-id-method.xml"));
...
BOOST_AUTO_TEST_CASE (test088GlobalInitMethodIncluded)
{
        ...
        BeanFactoryContainer *cont = ContainerFactory::createAndInit (CompactMetaService::parseFile (PATH + "088-import-global-init-method.xml"));
