...
{
        BeanFactoryContainer *cont = ContainerTestFactory::getContainer (PATH + "026-test-singleton.xml");
...
{
        BeanFactoryContainer *cont = ContainerTestFactory::getContainer (PATH + "027-embeded-bean.xml");
...
{
        BeanFactoryContainer *cont = ContainerTestFactory::getContainer (PATH + "028-embeded-map.xml");
...
{
        BeanFactoryContainer *cont = ContainerTestFactory::getContainer (PATH + "029-embeded-list.xml");
...
{
        BeanFactoryContainer *cont = ContainerTestFactory::getContainer (PATH + "030-bean-in-carg.xml");
