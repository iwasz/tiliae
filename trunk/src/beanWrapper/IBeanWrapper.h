...
public:
        ...
        virtual void set (const std::string &path, const Core::Variant &object, Common::Context *ctx = NULL) = 0;
        virtual void add (const std::string &path, const Core::Variant &object, Common::Context *ctx = NULL) = 0;
        virtual Core::Variant get (const std::string &path, Common::Context *ctx = NULL) const = 0;
        virtual Ptr <Core::IIterator> iterator (const std::string &path, Common::Context *ctx = NULL) const = 0;
